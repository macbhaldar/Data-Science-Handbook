...
# func returns train and test data. It takes dataset and then split size test_size =0.3 means 30% data is for test and rest for training and random_state 
...
# Build Model
# only 10 trees will b ok as dataset is only 400+ records. Default is 100. 
